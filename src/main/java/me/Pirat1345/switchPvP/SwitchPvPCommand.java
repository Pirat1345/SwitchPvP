...
public class SwitchPvPCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            if (player.isOp()) {
                ...
                // Zeige nur erlaubte Commands für normale Spieler
                player.sendMessage("§6SwitchPvP Commands:");
                player.sendMessage("§a/switchpvp join §7- Spiel beitreten");
                player.sendMessage("§a/switchpvp leave §7- Spiel verlassen");
            }
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 1) {
            // Für normale Spieler nur join und leave anzeigen
            if (!player.isOp()) {
                List<String> allowedCommands = Arrays.asList("join", "leave");
                ...
                // Für OPs alle Commands anzeigen
